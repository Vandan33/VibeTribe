...
class valleyofflowers extends StatefulWidget {
  const valleyofflowers({super.key});

  @override
  State<valleyofflowers> createState() => _valleyofflowersState();
}

class _valleyofflowersState extends State<valleyofflowers> {
         ...
         child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Stack(
              ...
              Image.asset("assets/valleyofflowers.avif",),
              Padding(
                padding: const EdgeInsets.only(top: 260,left: 20),
                child: Text("Valley of flowers (Monsoon)",style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                ),),
              ),
              ...
              Padding(
                ...
                child: Text("Ghangaria , Valley of Flowers , Hemkund Sahib , Ghangaria to Poolna ",style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: Colors.grey,
                ),),
...
class ItineraryScreen extends StatelessWidget {
  final List<Map<String, dynamic>> itnerarydata=[
    {
       "day": "DAY 1",
      "title": " Rishikesh - Karchi",
      "details": [
      "Drive Distance: 255 km",
      "Drive Duration: 11 hours",
      "The pick-up location is at Live Free Hostel, Rishikesh at 5:00 AM"
      ],
    },
      {
      "day": "DAY 2",
      "title": "Drive from Karchi to Poolna. Trek to Ghangaria",
      "details": [  
    ...
    "Altitude gain: 10,520 ft to 11,550 ft"
    ...
    },
     {
      ...
      "Altitude gain: 10,520 ft to 14,450 ft"
      ],
    },
    {
      "day": "DAY 5",
      "title": "Trek from Ghangaria to Poolna. Drive to Dhak",
      "details": [
     "Trek distance: 9 km",
     ...
     {
      "day": "DAY 6",
      "title": "Drive from Dhak to Rishikesh",
      "details": [
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text("5-June",style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                          ),),
                        ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                         Padding(
                          padding: const EdgeInsets.only(top: 10),
                          child: Text("15-June",style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                          ),),
                        ),
