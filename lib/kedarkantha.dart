...
class Kedarkantha extends StatefulWidget {
  const Kedarkantha({super.key});

  @override
  State<Kedarkantha> createState() => _KedarkanthaState();
}

class _KedarkanthaState extends State<Kedarkantha> {
         ...
         child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Stack(
              ...
              Image.asset("assets/kedarkantha.jpg"),
              Padding(
                padding: const EdgeInsets.only(top: 260,left: 20),
                child: Text("Kedarkantha Trek",style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                ),),
              ),
              ...
              Padding(
                ...
                child: Text("Kotgaon , Khujaai , BhojaDhadi , Kedarkantha Summit ",style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: Colors.grey,
                ),),
  ...
  final List<Map<String, dynamic>> itnerarydata=[
    {
      ...
      "details": [
        "Transport will be arranged at 6.30 AM.",
        "The cab can also pick you up from Library Chowk, Mall Road, Mussoorie at 7.30 AM. "
      ],
    },
      {
      "day": "DAY 2",
      "title": "Trek from Kotgaon to Khujaai",
      "details": [
    ...
    {
      "day": "DAY 3",
      "title": "Trek from Khujaai to Bhoja Dhadi",
      "details": [
       "Trek Distance: 3 km",
     ...
     {
      "day": "DAY 4",
      "title": "Trek from Bhoja Dhadi to Khujaai via Kedarkantha Summit",
      "details": [
        "Trek Distance: 9 km",
        "Trek Duration: 7-8 hours",
        "Altitude Gain: 10,700 ft to 9,460 ft via 12,500 ft"
      ],
    },
    {
      "day": "DAY 5",
      "title": "Trek from Khujaai to Kotgaon",
      "details": [
       "Trek Distance: 5.3 km ",
       "Trek Duration: 4-5 hours ",
       "Altitude Loss: 9,460 ft ft to 6,400 ft",
      ],
    },
     {
      "day": "DAY 6",
      "title": "Drive back from Kotgaon to Dehradun",
      "details": [
        "Drive Distance: 200 km",
        "Drive Duration: 10-11 hours",
        "Place - Grand Legacy Hotel, near Laal Pul, Dehradun "
      ],
    },
  ];
  @override
