...
class rupinpass extends StatefulWidget {
  const rupinpass({super.key});

  @override
  State<rupinpass> createState() => _rupinpassState();
}

class _rupinpassState extends State<rupinpass> {
         ...
         child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Stack(
              ...
              Image.asset("assets/rupinpasstrek.avif",),
              Padding(
                padding: const EdgeInsets.only(top: 260,left: 20),
                child: Text("Rupin Pass Trek (Summer)",style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                ),),
              ),
              ...
              Padding(
                ...
                child: Text("Jiskun , Jakha , Saruwas Thatch , Dhanderas Thatch,  Upper Waterfall , Rupin Pass",style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: Colors.grey,
                ),),
...
class ItineraryScreen extends StatelessWidget {
  final List<Map<String, dynamic>> itnerarydata=[
    {
       "day": "DAY 1",
      "title": "Drive from Rohru to Jiskun",
      "details": [
       "Drive distance: 85 km",
       "Drive Duration: 5 hours",
       "Transport will be organised from Kanwar Villa and Homestay, Rohru at 8.00 am."
      ],
    },
      {
      "day": "DAY 2",
      "title": "Trek from Jiskun to Jakha",
      "details": [
      "Trek Distance: 4 km ",
    ...
    {
      "day": "DAY 3",
      "title": "Trek from Jakha to Saruwas Thatch",
      "details": [
     ...
     {
      "day": "DAY 4",
      "title": "Trek from Saruwas Thatch to Dhanderas Thatch",
      "details": [
      "Trek Distance: 3 km",
    ...
    {
      "day": "DAY 5",
      "title": "Trek from Dhanderas Thatch to Upper Waterfall",
      "details": [
     ...
     {
      "day": "DAY 6",
      "title": "Pass-crossing day: Upper Waterfall camp to Rupin Pass, further on to Ronti Gad",
      "details": [
     ...
     {
      "day": "DAY 7",
      "title": "Trek from Ronti Gad to Sangla Kanda. Drive to Sangla and then a drive to Shimla",
      "details": [
     "Trek Distance: 11.9 km",
     "Trek Duration: 6 hours",
     "Transport will be arranged for your return journey."
      ],
    },
  ];
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                         Padding(
                          padding: const EdgeInsets.only(top: 10),
                          child: Text("30-May",style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                          ),),
                        ),
