...
class harkidun extends StatefulWidget {
  const harkidun({super.key});

  @override
  State<harkidun> createState() => _harkidunState();
}

class _harkidunState extends State<harkidun> {
         ...
         child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Stack(
              ...
              Image.asset("assets/harkidun.jpg",),
              Padding(
                padding: const EdgeInsets.only(top: 260,left: 20),
                child: Text("Har Ki Dun Trek (Summer Trek)",style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                ),),
              ),
              ...
              Padding(
                ...
                child: Text("Gangaad , Kalkatiyadhar , Boslo, Har Ki Dun",style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: Colors.grey,
                ),),
...
class ItineraryScreen extends StatelessWidget {
  final List<Map<String, dynamic>> itnerarydata=[
    {
       "day": "DAY 1",
      "title": " Dehradun - Kotgaon",
      "details": [
        "Drive Distance: 196 km ",
        "Drive Duration: 9-10 hours",
        "Transport will be organised from Hotel Grand Legacy, near Laal Pull, Dehradun at 6.30 AM.",
      ],
    },
      {
      "day": "DAY 2",
      "title": "Drive from Kotgaon to Dhatmeer.",
      "details": [
    ...
    {
      "day": "DAY 3",
      "title": "Trek from Gangaad to Kalkatiyadhar via Osla",
      "details": [
      "Trek Distance: 8 km",
     ...
     {
      "day": "DAY 4",
      "title": "Trek from Tilandi to Brahmatal via Brahmatal Top",
      "details": [
       "Trek Distance: 9 km ",
       "Trek Duration: 5-6 hours ",
       "Altitude Gain and Loss: 10,032 ft to 10,760 ft via 11,600 ft"
      ],
    },
    {
      "day": "DAY 5",
      "title": "Trek from Boslo to Chillurgad",
      "details": [
       "Trek Distance: 5.5 km",
       "Trek Duration: 5 hours",
       "Altitude Gain: 10,760 ft to 9,930 ft"
      ],
    },
     {
      "day": "DAY 6",
      "title": "Trek from Chillurgad via Dhatmeer and drive back to Kotgaon",
      "details": [
      "Trek Distance: 14 km",
      "Trek Duration: 6-7 hours",
      "Altitude Gain and Loss: 9,930 ft to 7,825 ft"
      ],
    },
     {
      "day": "DAY 7",
      "title": "Drive from Kotgaon to Dehradun",
      "details": [
      "Drive Distance: 196 km",
      "Drive Duration: 9-10 hours",
      ],
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text("1-Jan",style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                          ),),
                        ),
