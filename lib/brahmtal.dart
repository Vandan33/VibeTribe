...
class brahmtal extends StatefulWidget {
  const brahmtal({super.key});

  @override
  State<brahmtal> createState() => _brahmtalState();
}

class _brahmtalState extends State<brahmtal> {
          ...
          body: SingleChildScrollView(
            child: Stack(
              ...
              Padding(
                ...
                child: Text("Brahmatal Trek",style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                ),),
              ),
              ...
              Padding(
                ...
                child: Text("Lohajung , Gujreni , Tilandi , Brahmatal Summit",style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: Colors.grey,
                ),),
...
class ItineraryScreen extends StatelessWidget {
  final List<Map<String, dynamic>> itnerarydata=[
    {
       "day": "DAY 1",
      "title": "Rishikesh - Lohajung",
      "details": [
        "Transport will be arranged from Live Free Hostel, Rishikesh at 5.00 am.",
      ...
      {
      "day": "DAY 2",
      "title": "Trek from Lohajung to Gujreni",
      "details": [
    ...
    {
      "day": "DAY 3",
      "title": "Trek from Gujreni to Tilandi",
      "details": [
    ...
    {
      "day": "DAY 5",
      "title": "Trek from Brahmatal to Lohajung",
      "details": [
