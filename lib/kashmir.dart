         ...
         child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Stack(
              ...
              Image.asset("assets/kashmir3.webp",),
              Padding(
                padding: const EdgeInsets.only(top: 260,left: 20),
                child: Text("Kashmir",style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                ),),
              ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Text("10 Days & 9 Nights",style: TextStyle(
                      color: Colors.grey,
                      fontSize: 15,
              ...
              Padding(
                ...
                child: Text("Vaishnodevi , Srinagar , Sonmarg Excrusion , Gulmarg Excrusion , Pahalgam , Patnitop",style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: Colors.grey,
                ),),
  ...
  final List<Map<String, dynamic>> itnerarydata=[
    {
      ...
      "Start your heavenly journey for Kashmir",
      "Overnight Journey"
      ],
    },
      {
      ...
      "title": "Delhi - Katra",
      "details": [  
      "Pick up from Delhi Station and Proceed to Katra",
      "Check-in to Hotel",
      "Stay at Katra"
      ],
    },
    {
      ...
      "details": [
   "Breakfast",
   "Proceed to Vaishnodevi Darshan (by your own)",
   "Trek to Mata Vaishno Devi shrine (14 km), ponies can also be arranged by yourself (at your own cost)",
   ...
   "Overnight Stay at Katra",
    ...
    },
     {
      ...
      "details": [
     "Breakfast",
     "Check out & proceed to Srinagar",
     "Enroute visit Various Tunnel which excellence the Beauty and Show Engineering Marvel of India.",
     "Proceed for local sightseeing of Srinagar, Visit Mughal Gardens: Nishat Bagh & Shalimar Bagh, Shri Shankaracharya Temple",
    ...
    },
    {
      ...
      "details": [
    "Breakfast",
    "Proceed to Excursion trip to Sonmarg",
    ...
    "In the evening drive back from Sonmarg and transfer to hotel",
    "Dinner & Stay at Srinagar",
      ],
    },
     {
      "day": "DAY 6",
      ...
      "Proceed to Excursion trip to Gulmarg",
      "Enjoy a picturesque drive to Gulmarg, it is home to the highest 18 hole golf course of the world.",
      "Arrive and Enjoy a Gondola ride own cost. (Gondola ride is subject to weather conditions)",
      "Gulmarg is one of the best skiing destinations in India and is known for its colourful meadows",
    ...
    },
     {
      ...
      "details": [
        ...
        "Check-in to Hotel",
        "Dinner",
        "Stay at Pahalgam/Patnitop"
      ],
    },
     {
      "day": "DAY 8",
      "title": "Pahalgam - Amritsar",
      "details": [
       "Breakfast",
       "Checkout from Hotel",
       "Proceed to Amritsar",
    ...
    },
    {
      ...
      "title": "Delhi Arrival",
      "details": [
      "Reach Delhi & Board train for your city",
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Text("December 2025",style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                    ),),
                  ],
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text("5-Dec",style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                          ),),
                        ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                         Padding(
                          padding: const EdgeInsets.only(top: 10),
                          child: Text("15-Dec",style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                          ),),
                        ),
